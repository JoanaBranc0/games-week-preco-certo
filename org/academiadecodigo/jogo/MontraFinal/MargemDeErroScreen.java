...
public class MargemDeErroScreen implements Screen {
    ...
    public MargemDeErroScreen() {
        ...
        greyBox10 = new Picture(474, 367, "resources/MontraFinal/MargemDeErro/yellow_box.png");
    ...
    //this method has to be invoked in the handler maybe
    ...
    //this method chooses which margin the player will have
